...
type Config struct {
	...
	// Extra is a free-form field which can be used to add some custom information to the request header.
	// This field allows you to determine how to handle the request in webhook handler or other plugins.
	// For example, you can add some identity information to the request header and use this information in
	// the webhook handler to determine whether the request is generated by controller or other components like kubectl.
